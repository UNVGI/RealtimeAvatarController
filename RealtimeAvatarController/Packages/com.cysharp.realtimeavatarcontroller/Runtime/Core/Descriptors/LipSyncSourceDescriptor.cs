...
namespace RealtimeAvatarController.Core
{
    ...
    {
        /// <summary>Registry に登録された具象型を識別するキー (例: "OVRLipSync", "Viseme")。</summary>
        public string SourceTypeId;

        /// <summary>
        /// 具象型ごとのコンフィグ。LipSyncSourceConfigBase (ScriptableObject 派生) を参照する。
